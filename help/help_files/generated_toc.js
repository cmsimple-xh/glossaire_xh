/** Generated TOC
    ...
    jul 2016 - Ludovic AMATHIEU => Add fr language by class detect of id#generated-toc
...
generated_toc = {
  generate: function() {
    ...
    if (tocparent) {
      ...
      // récupération nom class pour définir la langue
      lng = tocparent.getAttribute("class");
      // définition des textes selon la langue
      switch(lng) {
          case "fr":
                SHOW_TOC = "Montrer le sommaire";
                HIDE_TOC = "Masquer le sommaire";
          break;
          case "de":
                SHOW_TOC = "Zeige das Inhaltsverzeichnis";
                HIDE_TOC = "Verstecke das Inhaltsverzeichnis";
          break;
          default:
    ...
    if (status && status == "open") {
      ...
      toggle_initially = HIDE_TOC;
    } else {
      display_initially = "none";
      toggle_initially = SHOW_TOC;
    }
  ...
  wrapOpenClose: function(a, cur_list_el) {
    ...
    return function(e) {
      ...
      a.firstChild.nodeValue = (d == 'block') ? SHOW_TOC : HIDE_TOC;
